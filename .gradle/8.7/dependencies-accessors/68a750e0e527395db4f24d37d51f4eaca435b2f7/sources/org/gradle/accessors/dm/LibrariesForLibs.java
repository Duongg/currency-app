...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class KotlinxLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>date.time</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class KtorClientContentLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>negotialion</b> with <b>io.ktor:ktor-client-content-negotiation</b> coordinates and
         * with version reference <b>ktor</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getNegotialion() {
            return create("ktor.client.content.negotialion");
        }
    ...
    public static class StatelyLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>statelyCommon</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class VoyagerLibraryAccessors extends SubDependencyFactory {
        private final VoyagerScreenLibraryAccessors laccForVoyagerScreenLibraryAccessors = new VoyagerScreenLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>voyager.screen</b>
         */
        public VoyagerScreenLibraryAccessors getScreen() {
            return laccForVoyagerScreenLibraryAccessors;
        }

    }

    public static class VoyagerScreenLibraryAccessors extends SubDependencyFactory {

        public VoyagerScreenLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getModel() {
            return create("voyager.screen.model");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>koinCore</b> with value <b>3.5.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>realm</b> with value <b>2.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>statelyCommon</b> with value <b>2.0.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getStatelyCommon() { return getVersion("statelyCommon"); }
    ...
    public static class DateVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>date.time</b> with value <b>0.5.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getTime() { return getVersion("date.time"); }
